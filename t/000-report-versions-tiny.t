...
eval { $v .= pmver('MooseX::POE::SweetArgs','any version') };
eval { $v .= pmver('POE','any version') };
eval { $v .= pmver('POE::Driver::SysRW','any version') };
eval { $v .= pmver('POE::Filter::Line','any version') };
eval { $v .= pmver('POE::Filter::Stream','any version') };
